...
The core of the Go News Feed Bot consists of two workers—**Fetcher** and **Publisher**—along with an **Admin Service**, as illustrated in the architecture diagram below (Fig. 1):
